...
STEP 1:
RUN 'input splitter.py'. IT WILL CREATE SLICES OF 'LBP.PNG' IMAGE. THESE SLICES ARE FURTHER FLIPPED HORIZONTALLY AND VERTICALLY, ROTATED BY 90 DEGREES. HENCE FOR EVERY 1 SLICE TRAVERSED IN THE 'LBP.PNG' 4 IMAGES ARE SAVED IN THE 'LBP INPUTS FOR TRAINING' FOLDER. 
